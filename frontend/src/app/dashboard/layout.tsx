...
import { LayoutDashboard, Upload, Sliders, Scissors, Disc3, CreditCard, Crown, Settings, LogOut, Menu, X } from "lucide-react";
...
const navItems = [
  ...
  { href: "/dashboard/stems", icon: Scissors, label: "Stems" },
  { href: "/dashboard/releases", icon: Disc3, label: "Releases" },
